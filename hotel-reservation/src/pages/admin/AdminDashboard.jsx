...
function AdminDashboard() {
  ...
  const { getHomes } = useHomeFunctions();
  ...
  const getAllHomes = async () => {
    ...
    console.log("homesResponse from adminDash > ", homesResponse?.data);
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
          <Card className="sm:col-span-2" x-chunk="dashboard-05-chunk-0">
            <CardHeader className="pb-3">
              <CardTitle className="text-2xl ">
                Welcome, to{" "}
                <span className="text-primary font-bold">Sarah Homestay</span>
              </CardTitle>

              <CardDescription className="max-w-lg text-balance leading-relaxed">
                Seamlessly manage your rental homes with Sarah Homestay. Oversee
                bookings, monitor guest stays, and gain valuable insights to
                provide a comfortable and unforgettable experience for your
                clients.
              </CardDescription>
            </CardHeader>
            <CardFooter>
          ...
          <Card x-chunk="dashboard-05-chunk-1">
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-4xl">{homes?.length}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <TabsContent value="month">
            <Card x-chunk="dashboard-05-chunk-3">
              <CardHeader className="px-7">
                ...
                <CardDescription>
                  Recent bookings in your system.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
